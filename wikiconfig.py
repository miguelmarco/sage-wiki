...
class Config(multiconfig.DefaultConfig):
    ...
    sitename = u'Sage Wiki'

    # Wiki logo. You can use an image, text or both. [Unicode]
    # For no logo or text, use '' - the default is to show the sitename.
    # See also url_prefix setting below!
    #logo_string = u'<img src="%s/common/moinmoin.png" alt="MoinMoin Logo">' % url_prefix_static
    logo_string = u'<a href="http://www.unizar.es"> <img src="https://www.unizar.es/sites/all/themes/unizar/img/logo_uz.png"> </a>'

    # name of entry page / front page [Unicode], choose one of those:

    # a) if most wiki content is in a single language
    page_front_page = u"Inicio"
    ...
    superuser = [u"admin", u"mmarco"]

    # IMPORTANT: grant yourself admin rights! replace YourName with
    # your user name. See HelpOnAccessControlLists for more help.
    # All acl_rights_xxx options must use unicode [Unicode]
    #acl_rights_before = u"SageAdmin:read,write,delete,revert,admin"
    ...
    html_head = '<script type="text/javascript" src="%s/common/js/jsmath/easy/load.js"></script>' % url_prefix_static
    html_head += '<script type="text/javascript" src="https://sagecell.sagemath.org/static/jquery.min.js"></script>'
    html_head += '<script type="text/javascript" src="https://sagecell.sagemath.org/embedded_sagecell.js"></script>'
    html_head += '<script>sagecell.makeSagecell({"inputLocation": ".sage", "linked" : "true"});</script>'

    textchas_disabled_group = u"TrustedEditorGroup"
    textchas = {
        'es': { 
            u"Introduce el nombre del software sobre el que trata esta wiki?": ur"Sage|sage|SAGE|Sagemath|SageMath|sagemath"
            }}
